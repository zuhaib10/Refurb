...
const Form: FC<FormProps> = ({}) => {
  ...
  return (
    ...
    <form aria-label="Sell Your Phone Form" className="rounded-xl p-10 md:relative grid grid-cols-2  gap-2 bg-[#FAFAFA] border border-[#DADADA] " onSubmit={handleFormSubmit}>
    ...
    // <form aria-label="Sell Your Phone Form" className="rounded-xl p-10 md:relative grid grid-cols-1  gap-2 bg-[#FAFAFA] border border-[#DADADA] " onSubmit={handleFormSubmit}>
