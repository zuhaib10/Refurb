  ...
  return (
    <main role="main" className="container m-auto grid  sm:grid-cols-2 grid-cols-1 gap-x-10 items-center ">
      <div className="max-w-2xl pt-24 pb-32">
        <h1 className="md:text-[40px] text-[24px] font-bold w-[90%] leading-normal text-[#02213A]" >
        ...
        <div className="flex gap-10 items-center mt-8 overflow-hidden">
      ...
      <div className="basis-5/12 relative top-24 ml-auto md:w-[85%] w-full">
        <Form />
      </div>
    </main>
  );
